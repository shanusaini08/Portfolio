// src/components/KeyFeaturesSection/KeyFeaturesSection.jsx
          ...
          <Card className="key-feature-card">
            <CardContent>
              ...
              <Typography variant="body1" className="key-feature-text">
                ...
                cutting-edge modern technologies like blockchain, IoT, AR/VR, AI, big data, and machine learning.
              </Typography>
            </CardContent>
          </Card>
        </Grid>
        ...
        <Grid item xs={12} md={4}>
          <Card className="key-feature-card">
            <CardContent>
              ...
              <Typography variant="body1" className="key-feature-text">
                A day full of Excellence. Your Ideas + Our Knowledge = Highest Levels of Client Success.By combining your innovative ideas with our deep expertise and industry knowledge, we strive to reach the highest levels of client success. 
              </Typography>
            </CardContent>
          </Card>
        </Grid>
